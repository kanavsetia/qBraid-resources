...
width=1.5
height=1.5
p = figure(x_range=(-width,width), y_range=(-height,height), width=500, height=500)
plot_settings(p)
...
p.add_layout(LabelSet(source = source,x='x',y='y',text='label',x_offset = 5, y_offset = 5,text_font_size='20px'))
