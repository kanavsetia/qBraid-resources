...
height=200
plot1 = figure(x_range=(-np.pi*2,np.pi*2), y_range=(-2.1,2.1), width=600, height=height)
plot2 = figure(x_range=(-np.pi*2,np.pi*2), y_range=(-2.1,2.1), width=600, height=height)
plot_settings(plot1)
plot_settings(plot2)
